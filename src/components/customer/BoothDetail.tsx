...
export default function BoothDetail({ booth }: BoothDetailProps) {
    ...
    const avgRating = useMemo(() => {
        ...
        const sum = booth.reviews.reduce(
                ...
                <div className="lg:col-span-3">
                    ...
                    <div className="relative mb-6 h-80 overflow-hidden rounded-2xl bg-gray-200 sm:h-96 lg:h-[420px]">
                        ...
                        <div className="absolute top-4 right-4">
                            <span
                                className={`inline-flex items-center gap-1.5 rounded-full px-4 py-2 text-xs font-bold uppercase tracking-wider shadow-sm backdrop-blur-md ${booth.is_available
                                    ...
                                    {booth.reviews.map((review) => (
                                        ...
                                        >
                                            <div className="mb-2 flex items-center justify-between">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <span
                                                        className={`rounded-full px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider ${review.type === "BOOTH"
                ...
                <div className="lg:col-span-2">
                    <div className="sticky top-28 rounded-2xl bg-white p-6 shadow-lg ring-1 ring-gray-100">
                        ...
                        <div className="mb-4 space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full rounded-xl border border-gray-200 px-4 py-3 text-sm outline-none transition-all focus:border-orange-300 focus:ring-2 focus:ring-orange-100"
                                />
                            </div>
                            <div>
                                <label className="mb-1.5 block text-sm font-medium text-gray-700">
                        ...
                        <button
                            ...
                            className={`w-full rounded-xl py-4 text-sm font-bold uppercase tracking-wider transition-all ${days > 0 && booth.is_available
